...
export default function Sidebar({state,callBack}:SidebarTypes) {
  ...
  return (
    <div className={classnames(styles.sidebarContainer,{[styles.sidebarActive]: state})}>
        ...
        <div className={ classnames(styles.overlay,{[styles.activeOverlay] : state})} onClick={hideSideBar}></div>
